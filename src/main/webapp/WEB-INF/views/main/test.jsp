        ...
        <aside class="main-sidebar col-12 col-md-3 col-lg-2 px-0">
          ...
          <div class="nav-wrapper">
            <ul class="nav flex-column">
              <li class="nav-item">
                <a class="nav-link active" href="/resources/index.html">
                  <i class="material-icons">edit</i>
                  <span>Blog Dashboard</span>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link " href="/resources/components-blog-posts.html">
                  <i class="material-icons">vertical_split</i>
                  <span>Blog Posts</span>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link " href="/resources/add-new-post.html">
                  <i class="material-icons">note_add</i>
                  <span>Add New Post</span>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link " href="/resources/form-components.html">
              ...
              <li class="nav-item">
                <a class="nav-link " href="/resources/user-profile-lite.html">
                  <i class="material-icons">person</i>
                  <span>User Profile</span>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link " href="/resources/errors.html">
              ...
              <ul class="navbar-nav border-left flex-row ">
                ...
                <li class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu dropdown-menu-small">
                    <a class="dropdown-item" href="/resources/user-profile-lite.html">
                      <i class="material-icons">&#xE7FD;</i> Profile</a>
                    <a class="dropdown-item" href="/resources/components-blog-posts.html">
                      <i class="material-icons">vertical_split</i> Blog Posts</a>
                    <a class="dropdown-item" href="/resources/add-new-post.html">
                  ...
                  <div class="card-body p-0">
                    <div class="blog-comments__item d-flex p-3">
                      <div class="blog-comments__avatar mr-3">
                        <img src="/resources/images/avatars/1.jpg" alt="User avatar" /> </div>
