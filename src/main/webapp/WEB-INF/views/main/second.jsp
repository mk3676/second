	...
	setInterval(() => {
		...
		$.ajax({
			...
			success(result) {
				...
				$("#tempNhumidUpdate").html("<div><i class='bi bi-stopwatch'></i>  " + hour + "시 " + date.getMinutes() + "분 " + date.getSeconds() + "초" + "</div><div>" + "<i class='bi bi-thermometer-half'></i>  " + result.temp + "°C    <i class='bi bi-speedometer2'></i>  " + result.humi + "%" + "</div > ")
			}
		})
	}, 5000);
})
			...
			<div class="row">
				...
				<div class="col-lg-4">
					...
					<div class="card">
						...
						<div class="card-body pt-3 pb-3">
							<h6 class="card-subtitle mb-2 text-muted">5초에 한번씩 갱신됩니다.</h6>
